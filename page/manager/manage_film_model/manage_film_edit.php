    ...
    ?>
        <form action="" method="post" enctype="multipart/form-data">
            <div class="manage-film__edit--content">
                ...
                <h1 class="manage-film__edit-title">CHỈNH SỬA PHIM</h1>
                ...
                <div class="manage-film__edit col-l-12 col-md-12 col-sm-12">
                    <p class="manage-film__edit--para col-l-4 col-md-4 col-sm-6">Hình ảnh (Không được chỉnh sửa)</p>
                    <input class="manage-film__input--edit col-l-8 col-md-8 col-sm-6" value="" type="file" id="photo" name="photo">
                </div>

                <div class="manage-film__edit col-l-12 col-md-12 col-sm-12">
                    <p class="manage-film__edit--para col-l-4 col-md-4 col-sm-6">Trailer (Không được chỉnh sửa)</p>
                    <input class="manage-film__input--edit col-l-8 col-md-8 col-sm-6" value="" type="file" id="" name="trailer">
                </div>

                <div class="manage-film__edit col-l-12 col-md-12 col-sm-12">
                    <p class="manage-film__edit--para col-l-4 col-md-4 col-sm-6">Trang (Không được chỉnh sửa)</p>
                    ...
                    if(isset($_POST['edit_btn'])){
                        ...
                        && !empty($_POST['rated'])){
                            ...
                            if(!empty($_POST['photo']) && !empty($_POST['trailer']) && !empty($_POST['slider'])){
                                ...
                                echo "<p class='col-l-12 col-md-12 col-sm-12' style='color: red; font-weight: bold; text-align:center;'>Chỉnh sửa thành công!</p>";
                            }
                ...
                ?>
                <button name="edit_btn" class="manage-film__edit--btn">Chỉnh sửa</button>
            </div>
