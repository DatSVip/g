...
<div class="manage-user">
        <!-- <form onsubmit="" action="" method="post"> -->
            ...
            <h1 class="manage-film__title manage-user__title">QUẢN LÝ PHIM</h1></h1>

            <div class="manage-film__bar">
                
                <input placeholder="Tìm kiếm phim trong tất cả" type="text" name="" id="search-input" class="manage-film__input">
                <div class="manage-film__btn">
                    <a href="?page=manage_film_add_film" class="manage-film__add manage-film__add-film">Thêm mới phim</a>
                </div>
            </div>
            ...
            <table id="table" class="manage-user__table">
                <tbody id="tbody" class="manage-film__tbody manage-user__tbody">
                    <tr class="manage-film__tr-main manage-user__tr">
                        ...
                        <th class="manage-film__th manage-user__th">Tên</th>
                        ...
                        <th class="manage-film__th manage-user__th">Thời lượng</th>
                        <th class="manage-film__th manage-user__th">Ngày công chiếu</th>
                        ...
                        <th class="manage-film__th manage-user__th">Chỉnh sửa</th>
                        <th class="manage-film__th manage-user__th">Xóa</th>
                        <th class="manage-film__th manage-user__th">Thêm thời lượng</th>
                        <th class="manage-film__th manage-user__th">Thông tin thêm</th>
                        <th class="manage-film__th manage-user__th">Thêm thể loại phim</th>
                    </tr>
                ...
                <div id="delete-res" class="delete-res d-none">
                    ...
                    <div class="delete-res__site">
                        ...
                        <a class="delete-res__items" href="?page=manage_film">Không đồng ý</a>
                    </div>
                </div>
                ...
                <div id="add-type" class="delete-res d-none">
                    ...
                    <div class="delete-res__site">
                        <div style="cursor: pointer;" onclick="onClickYes()" id="add-type__link" class="delete-res__items">Đồng ý</div>
                        <a class="delete-res__items" href="?page=manage_film">Không đồng ý</a>
                    </div>
                </div>
