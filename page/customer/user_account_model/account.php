...
<body>
    <div class="account-content__title">
        <h1 class="account-content__account--header">Thông tin tài khoản</h1>
    </div>
    ...
    <div class="account-content__account">
        ...
        <div class="account-content__account--name-inp account-content__account--info">
            <p class="account-content__account--para account-content__account--name">Họ và tên (*)</p>
        ...
        <div class="account-content__account--phone-inp account-content__account--info">
            <p class="account-content__account--para account-content__account--phone">Số điện thoại (*)</p>
        ...
        <div class="account-content__account--dob-inp account-content__account--info">
            <p class="account-content__account--para account-content__account--dob">Day Of Birth(*)</p>
        ...
        <div class="account-content__account--gender-inp account-content__account--info">
            <p class="account-content__account--para account-content__account--gender">Giới tính ( M, F / Nam, Nữ) (*)</p>
        ...
        <div id="account-content__current-pass" class="account-content__account--pass-inp account-content__account--info">
            <p class="account-content__account--para account-content__account--pass">Mật khẩu hiện tại (*)</p>
        ...
        <div class="account-content__account--pass-inp account-content__account--info">
            <p class="account-content__account--para account-content__account--pass">Thay đổi mật khẩu?</p>
        ...
        <div id="account-content__new-pass" class="d-none account-content__account--pass-inp account-content__account--info">
            <p class="account-content__account--para account-content__account--pass">Mật khẩu mới(*)</p>
        ...
        <div id="account-content__re-new--pass" class="d-none account-content__account--pass-inp account-content__account--info">
            <p class="account-content__account--para account-content__account--pass">Nhập lại mật khẩu mới(*)</p>
            ...
            if(isset($_POST['account__new-pass']) && isset($_POST['account__re-new-pass'])){
                ...
                !empty($_POST['account__new-pass']) && !empty($_POST['account__re-new-pass'])){
                    ...
                    if(checkCustomerPass($curPass) && $newPass == $reNewPass){
                        ...
                        echo "<p class='account-content__pass--wrong'>Thay đổi của bạn đã được lưu lại!</p>";

                    }else{
                        echo "<p class='account-content__pass--wrong'>Mật khẩu không hợp lệ!</p>";
                    }
                }else{
                    echo "<p class='account-content__pass--wrong'>Vui lòng nhập đầy đủ thông tin cần cập nhật!</p>";
                }
            }else{
    ...
    <button name="account-content__account--btn" class="account-content__account--btn" type="submit">Cập nhật</button>
