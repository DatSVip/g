                ...
                <div class="row booking-seat__content">
                        ...
                        <div class="booking-seat__content--info col-l-12 col-md-12">
                            ...
                            <p class="booking-seat__content--info-para">
                                <?php echo $cluster_Name." | ". $room_Name." | Tổng cộng các ghế: ". $room_Total_Seats   ?>
                            </p>
                        ...
                        <div class="booking-seat__content--notice col-l-12 col-md-12 col-sm-12">
                            <div class="booking-seat__content-seat-box ">
                                <div class="booking-seat__content-seat-box-type booking-seat__content--empty">
                                    ...
                                    <p class="booking-seat__content--para">Ghế trống</p>
                                </div>
                                <div class="booking-seat__content-seat-box-type booking-seat__content--booked">
                                    ...
                                    <p class="booking-seat__content--para">Ghế đã được đặt</p>
                                </div>
                                <div class="booking-seat__content-seat-box-type booking-seat__content--choosing">
                                    ...
                                    <p class="booking-seat__content--para">Chọn ghế</p>
                                </div>
                            </div>
                        ...
                        <p class="booking-seat__content--ticket-para">Thông tin vé</p>
                            <table class="booking-seat__content--table" cellspacing="0" style="text-align: center; border-color: var(--booked-seat);">
                                <tbody>
                                    ...
                                    <tr class="booking-seat__content--tr">
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Phim</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Ngày đặt</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Thể loại phim</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Thời gian</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Khu vực</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Danh mục</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Phòng</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Vị trí ngồi</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Thể loại ghế</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Giá tiền theo thể loại phim</p> </th>
                                        <th class="booking-seat__content-th"> <p class="booking-seat__content--th-para">Giá tiền</p> </th>
                                    </tr>
                            ...
                            <div class="booking-seat__content--ticket-total">
                                <h1 class="booking-seat__content--ticket-title">Tổng: </h1>
                            ...
                            <button name="btn__pay" onclick="" id="booking-seat__btn-pay" class="disabled-tag booking-seat__btn-pay">Tiếp theo</button>
                        </div>
                    </div>
            </div>
