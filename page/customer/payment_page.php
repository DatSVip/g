                ...
                <div class="row payment-content">
                    ...
                    <table cellspacing="0" class="payment-table">
                        <tbody class="payment-tbody">
                            <tr class="payment-tr payment-tr--th">
                                <th class="payment-th"><p class="payment-th__para">Phim</p></th>
                                <th class="payment-th"><p class="payment-th__para">Ngày đặt vé</p></th>
                                <th class="payment-th"><p class="payment-th__para">Thể loại phim</p></th>
                                <th class="payment-th"><p class="payment-th__para">Thời gian</p></th>
                                <th class="payment-th"><p class="payment-th__para">Khu vực</p></th>
                                <th class="payment-th"><p class="payment-th__para">Danh mục</p></th>
                                <th class="payment-th"><p class="payment-th__para">Phòng</p></th>
                                <th class="payment-th"><p class="payment-th__para">Vị trí ghế</p></th>
                                <th class="payment-th"><p class="payment-th__para">Thể loại ghế</p></th>
                                <th class="payment-th"><p class="payment-th__para">Gói Combo</p></th>
                                ...
                                <th class="payment-th"><p class="payment-th__para">Giá vé</p></th>
                            </tr>
                    ...
                    <div class="payment-voucher-method">
                        <div class="payment-voucher">
                            <h2 class="payment-voucher__header">Mã khuyến mãi</h2>
                            ...
                            <div id="payment-voucher__btn" name="payment-voucher__btn" class="payment-voucher__btn">Áp dụng</div>
                        </div>
        
                        <!-- payment method -->
                        <div class="payment-method">
                            <h2 class="payment-method__header">Phương thức thanh toán</h2>
                    ...
                    <div class="payment-total-price">
                        <h1 class="payemnt-total-price__header">Giá tiền:</h1>
                    ...
                    <div class="payment-total-voucher">
                        <h1 class="payemnt-total-voucher__header">Mã khuyến mãi:</h1>
                    ...
                    <div class="payment-total">
                        <h1 class="payemnt-total__header">Tổng:</h1>
                    ...
                    <p class="d-none col-l-12 col-md-12 col-sm-12" style="color: red;text-align: center; font-weight:bold;" id="function" >Tính năng chưa được cập nhật!</p>
                    <!-- name="purchase__btn" -->
                    <a id="purchase__btn" onclick="checkClickPaymentMethod()" type="submit" class="payment__btn">Thanh toán</a>
