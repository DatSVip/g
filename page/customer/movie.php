                ...
                <div class="films__choice col-l-12 col-md-12 col-sm-12">
                    <div class="film__choice--inner">
                        <div onclick="onClickShowTimeFilmChoice()" id="films__choice--show-time" class="films__choice--show-time">
                            <p class="films__choice--header">Phim Đang Chiếu</p>
                        </div>
                        ...
                        <div onclick="onClickUpcomingFilmChoice()" id="films__choice--upcoming" class="films__choice--upcoming">
                            <p class="films__choice--header">Phim Sắp Chiếu</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            ?>
                    <a id="<?= $film_ID ?>" href="?page=describe&filmID=<?php echo $film_ID ?>" class="films__items col-l-4 col-md-6 col-sm-12">
                        <div class="films__items--inner">
                            ...
                            <strong class="films__items--title">Thể loại: </strong> <span class="films__items--para films__items--type"><?php echo $film_Genre ?></span> </br>
                            <strong class="films__items--title">Thời lượng: </strong> <span class="films__items--para films__items--running-time"><?php echo $film_Running_time ?></span></br>
                            <strong class="films__items--title">Ngày công chiếu: </strong> <span class="films__items--para films__items--release-date"><?php echo $film_Release_date ?></span></br>
