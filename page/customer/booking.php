...
<script>
    ...
    <style>
        ...
        /* Hover effect */
        .booking-site__btn:hover {
            background-color: #28a745; /* Màu nền xanh lá cây khi hover */
        ...
        <div class="row booking-site">
            ...
            ?>
                <div class="booking-site__choice--header">
                    <p class="booking-site__choice--para">Khu vực</p>
                </div>
            ...
            ?>
                ...
                <div class="booking-site__choice--header <?php if($_GET['page'] == 'clusters') echo 'booking-site__choice--header-clusters' ?>">
                    <p class="booking-site__choice--para">Thể loại phim</p>
                </div>
                <?php
                    if($_GET['page'] == 'describe'){
                ?>
            ...
            <?php
                if($_GET['page'] == 'describe'){
            ?>
                <button onclick="onClickToReset()" id="booking-site__btn--choose-area-reset" class="booking-site__btn col-l-2 col-md-2 col-sm-2" type="reset">Đặt lại</button>
                <button name="btn_seacrh" onclick="onClickToSearch()" id="booking-site__btn--choose-search" class="booking-site__btn col-l-2 col-md-2 col-sm-2" type="submit">Tìm kiếm</button>
            <?php
                }else if($_GET['page'] == 'clusters'){
            ?>
                <!-- reset btn -->
                <button onclick="onClickToResetInCluster()" id="booking-site__btn--choose-area-reset" class="booking-site__btn col-l-2 col-md-2 col-sm-2" type="reset">Đặt lại</button>
                <!-- search btn -->
                <button name="btn_seacrh" onclick="onClickToSearchInCluster()" id="booking-site__btn--choose-search" class="booking-site__btn col-l-2 col-md-2 col-sm-2" type="submit">Tìm kiếm</button>            
