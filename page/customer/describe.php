            ...
            <div style="background-size: cover; background-image: linear-gradient(90deg, rgb(26, 26, 26) 25%, rgb(26, 26, 26) 38%,rgba(26, 26, 26, 0.04) 98%,rgb(26, 26, 26) 100%), url('<?php echo '/assets/img/'. $row['film_photo'] ?>');" class="row block__films film__describe--bg">
                <div class="film__describe--header col-l-12 col-md-12 col-sm-12">
                    <div class="film__describe--header-inner">
                        <p class="film__describe--title">CHI TIẾT VỀ PHIM</p>
                    </div>
                </div>
                ...
                <div class="film__describe--content col-l-12 col-md-12 col-sm-12">
                    ...
                    <!-- right -->
                        <div class="film__describe--right-details">
                            ...
                            <strong class="film__describe--right-details-strong">Tác giả: </strong> <span class="film__describe--right-details-info"><?php echo $film_Director ?></span> </br>
                            <strong class="film__describe--right-details-strong">Quay phim: </strong> <span class="film__describe--right-details-info"><?php echo $film_Cast ?></span> </br>
                            <strong class="film__describe--right-details-strong">Thể loại: </strong> <span class="film__describe--right-details-info"><?php echo $film_Genre ?></span></br>
                            <strong class="film__describe--right-details-strong">Thời lượng: </strong> <span class="film__describe--right-details-info"><?php echo $film_Running_time ?></span></br>
                            <strong class="film__describe--right-details-strong">Ngày phát sóng: </strong> <span class="film__describe--right-details-info"><?php echo $film_Release_date ?></span></br>
                            <strong class="film__describe--right-details-strong">Ngôn ngữ: </strong> <span class="film__describe--right-details-info"><?php echo $film_Language ?></span></br>
                            <strong class="film__describe--right-details-strong">Đánh giá: </strong> <span class="film__describe--right-details-info"><?php echo $film_Rated ?></span></br>
                ...
                <div class="film__describe--description">
                    <strong class="film__describe--right-details-strong">Mô tả: </strong> <span class="film__describe--right-details-info"><?php echo $film_Description ?></span></br>
                </div>
